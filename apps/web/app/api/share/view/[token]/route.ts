  ...
  try {
    ...
    try {
      ...
      return NextResponse.json({
        ...
        docTabs: (row.source_type === "doc" || row.source_type === "sheet") && meta.docTabs && typeof meta.docTabs === "object" ? meta.docTabs : undefined,
        mindmap: row.source_type === "mindmap" && meta.mindmap && typeof meta.mindmap === "object" ? meta.mindmap : undefined,
